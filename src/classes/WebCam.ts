...
export class WebCam extends DcNode {
  // properties
  ...
  constructor(id:string, typeInfo:any) {
    ...
    super(id,"webcam",ports,edges,cfg as any)
    DcNode.print(WebCam._type + " created") // no access to super._id etc here
    //WebCam.insts.set(id,this)
  }
  // methods
  ...
  // getters/setters
  get type() { return WebCam._type }
  get display() { return WebCam._display }
} 
